...
Baseline for this index: frontend **12.2.39**, canonical engine **1.2.8**, gm-copilot **v26**, gm-knowledge-ingest **v4**, including [truthful knowledge status reporting](knowledge-status-audit-2026-09-09.md), [current-mode investigation results](mode-intel-audit-2026-09-09.md), [renamed active standard-ID classification](active-standard-id-audit-2026-09-09.md) and [document embedding response validation](embedding-response-audit-2026-09-09.md). The latest completed JavaScript run contains **625 passing tests, zero failures and zero skips**, including the actual supplied Transformers DOCX. Lint/typecheck scripts are JavaScript syntax checks, not full static type analysis; the build script validates the static deployment, not a bundled application.
...
| 15 | Passives | Known triggers, exact encyclopedia aliases and renamed entries with explicit standard IDs execute automatically. Owned/borrowed identity and official targets verified. [Sources](passive-source-audit-2026-09-08.md), [targets](passive-event-target-audit-2026-09-08.md), [aliases](passive-alias-audit-2026-09-08.md), [standard IDs](passive-standard-id-audit-2026-09-08.md). | General custom dispatch, unsupported-passive review coverage, all listed events and passive reward causality still open. |
