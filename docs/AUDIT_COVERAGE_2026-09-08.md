...
Baseline for this index: frontend **12.2.40**, canonical engine **1.2.9**, gm-copilot **v26**, gm-knowledge-ingest **v5**, including [exclusive knowledge-ingestion claims](knowledge-claim-audit-2026-09-09.md), [visible unsupported passive review](unsupported-passive-review-audit-2026-09-09.md), [truthful knowledge status reporting](knowledge-status-audit-2026-09-09.md), [current-mode investigation results](mode-intel-audit-2026-09-09.md), [renamed active standard-ID classification](active-standard-id-audit-2026-09-09.md) and [document embedding response validation](embedding-response-audit-2026-09-09.md). The latest completed JavaScript run contains **651 passing tests, zero failures and zero skips**, including the actual supplied Transformers DOCX. Lint/typecheck scripts are JavaScript syntax checks, not full static type analysis; the build script validates the static deployment, not a bundled application.
