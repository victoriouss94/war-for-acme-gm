...
| 15 | Passives | Reflection, immunity, Counterattack and Mark triggers execute automatically. Exact owned ability/borrowed-role identity now verified in finalized events and analytics. [Passive sources](passive-source-audit-2026-09-08.md). | General custom event dispatch, all listed events and passive reward causality still open. |
