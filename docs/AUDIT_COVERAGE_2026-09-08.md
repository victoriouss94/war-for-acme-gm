...
Baseline for this index: frontend **12.2.35**, canonical engine **1.2.5**, gm-copilot **v25**, with [exact passive alias execution](passive-alias-audit-2026-09-08.md) and the [resolution accounting notice](resolution-accounting-display-audit-2026-09-08.md). The latest completed JavaScript run contains **572 passing tests, zero failures and zero skips**, including the actual supplied Transformers DOCX. Lint/typecheck scripts are JavaScript syntax checks, not full static type analysis; the build script validates the static deployment, not a bundled application.
...
| 15 | Passives | Known triggers and exact encyclopedia aliases execute automatically. Owned/borrowed role identity and official passive target arrays are verified. [Sources](passive-source-audit-2026-09-08.md), [targets](passive-event-target-audit-2026-09-08.md), [aliases](passive-alias-audit-2026-09-08.md). | General custom dispatch, unsupported-passive review coverage, all listed events and passive reward causality still open. |
...
| 50 | Checks | Latest suite 572/572, actual DOCX, syntax checks, static build and diff checks pass. | Script called typecheck is syntax only; no false TypeScript guarantee. |
