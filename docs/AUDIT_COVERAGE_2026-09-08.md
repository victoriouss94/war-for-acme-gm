...
Baseline for this index: frontend **12.2.38**, canonical engine **1.2.8**, gm-copilot **v26**, gm-knowledge-ingest **v3**, including [current-mode investigation results](mode-intel-audit-2026-09-09.md), [renamed active standard-ID classification](active-standard-id-audit-2026-09-09.md) and [document embedding response validation](embedding-response-audit-2026-09-09.md). The latest completed JavaScript run contains **613 passing tests, zero failures and zero skips**, including the actual supplied Transformers DOCX. Lint/typecheck scripts are JavaScript syntax checks, not full static type analysis; the build script validates the static deployment, not a bundled application.
...
| 39 | API errors | Auth/retry classification, invalid AI responses, draft failures and bounded usage-write retries with explicit recording warnings tested. [Accounting writes](ai-accounting-write-audit-2026-09-08.md). Invalid document embedding indexes/counts/vector members now fail without activating corrupted passage associations. [Embedding validation](embedding-response-audit-2026-09-09.md). | Durable reconciliation and other run/trace/conversation persistence errors remain open. |
...
| 50 | Checks | Latest suite 613/613, actual DOCX, syntax checks, static build and diff checks pass. | Script called typecheck is syntax only; no false TypeScript guarantee. |
