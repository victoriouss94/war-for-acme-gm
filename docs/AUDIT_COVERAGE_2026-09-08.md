...
Baseline for this index: frontend **12.2.41**, canonical engine **1.2.9**, gm-copilot **v26**, gm-knowledge-ingest **v5**, including [complete monthly recorded usage](ai-usage-summary-audit-2026-09-09.md), [exclusive knowledge-ingestion claims](knowledge-claim-audit-2026-09-09.md), [visible unsupported passive review](unsupported-passive-review-audit-2026-09-09.md), [truthful knowledge status reporting](knowledge-status-audit-2026-09-09.md), [current-mode investigation results](mode-intel-audit-2026-09-09.md), [renamed active standard-ID classification](active-standard-id-audit-2026-09-09.md) and [document embedding response validation](embedding-response-audit-2026-09-09.md). The latest completed JavaScript run contains **658 passing tests, zero failures and zero skips**, including the actual supplied Transformers DOCX. Lint/typecheck scripts are JavaScript syntax checks, not full static type analysis; the build script validates the static deployment, not a bundled application.
...
| 30 | Intel | Watch/Track invalid visitors fixed; Ask/swap and 0-visitor cases tested. Explicit current-mode appearance, invisibility, blocked privacy and correction recalculation now pass runtime and public approval fixtures. [Mode Intel](mode-intel-audit-2026-09-09.md). | Late-stage information dependency and every special intel rule remain open. |
...
| 55 | Do not hide failures | Unknown actions/past-stage effects require review; invalid source metadata is explicit; exhausted usage-write retries report incomplete accounting. The actual resolution renderer now displays a persistent [accounting notice](resolution-accounting-display-audit-2026-09-08.md). | No durable accounting guarantee; native-browser verification remains unavailable. |
