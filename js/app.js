import {analyzeDocumentBlocks,compareGameImport,importSummary,matchImportAbilities,normalizeAiDocumentImport,normalizeImportName,parseDocxFile,prepareDocumentBlocksForAi,validateGameImport} from './document-import.js?v=9.0.0';
import {COPILOT_MAX_MESSAGE_LENGTH,copilotChangeLabel,normalizeCopilotRequest,normalizeCopilotResponse,validateCopilotChanges} from './copilot.js?v=9.0.0';
import {knowledgeDocumentKey,knowledgeFileMetadata,reconcileOfficialAbilities,validateKnowledgeFile} from './knowledge.js?v=9.0.0';
...
function renderKnowledgeLibrary(){
  ...
  $('uploadKnowledgeBtn').disabled=knowledgePending||!canEditGame()||!selectedKnowledgeFile;$('knowledgeFile').disabled=knowledgePending||!canEditGame();$('knowledgeTitle').disabled=knowledgePending||!canEditGame();$('knowledgeType').disabled=knowledgePending||!canEditGame();$('knowledgeStatus').disabled=knowledgePending||!canEditGame();
