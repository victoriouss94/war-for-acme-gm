(function(){
  ...
  async function finalizeResolutionSession(sessionId,lockVersion,decision,manualResolution,explanation,teachAi,teachScope='GLOBAL',consumedActionIds=[]){return unwrap(await required().rpc('finalize_resolution_with_grants',{target_session_id:sessionId,expected_lock_version:lockVersion,target_decision:decision,target_manual_resolution:manualResolution||{},target_gm_explanation:explanation||'',target_teach_ai:Boolean(teachAi),target_teach_scope:teachScope,target_consumed_action_ids:consumedActionIds||[]}))}
