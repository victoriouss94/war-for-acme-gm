(function(){
  ...
  async function removeQueuedAction(gameId,gameVersion,actionId,reason){return unwrap(await required().rpc('remove_queued_action',{target_game_id:gameId,expected_game_version:gameVersion,target_action_id:actionId,target_reason:reason||''}))}
  ...
  async function subscribe(gameId,{onDocument,onMembership,onInvites,onStatuses,onAbilities,onResolution,onLearning,onPresence,onStatus}){
    await unsubscribe();
