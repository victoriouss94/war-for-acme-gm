...
export const roleModeAbilityMap={
  ...
  'Mark/Soul Bound – Bombshell':{modes:{'Robot Mode':['Mark'],'Alt Mode':['Death Immunity']},roleWide:[]},
  ...
  'Lawyer – Bluestreak':{modes:{'Robot Mode':['Save','Bulletproof / Passive Immunity'],'Alt Mode':['Bulletproof / Passive Immunity']},roleWide:[]},
