...
if(!app.includes("from './document-import.js?v=9.2.0'"))throw new Error('app.js does not load the versioned js/document-import.js');
if(!app.includes("from './copilot.js?v=9.2.0'"))throw new Error('app.js does not load the versioned js/copilot.js');
if(!app.includes("from './knowledge.js?v=9.2.0'"))throw new Error('app.js does not load the versioned js/knowledge.js');
if(!app.includes("from './statuses.js?v=9.2.0'"))throw new Error('app.js does not load the versioned js/statuses.js');
